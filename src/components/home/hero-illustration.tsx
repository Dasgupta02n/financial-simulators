    ...
    return (
      <div className="hidden lg:block absolute right-8 top-1/2 -translate-y-1/2 w-72 h-64">
        <svg viewBox="0 0 300 220" fill="none" className="w-full h-full">
          ...
          <rect x="40" y="30" width="50" height="140" rx="4" fill="#D8400E" opacity="0.15" />
          <text x="65" y="22" textAnchor="middle" fill="#D8400E" opacity="0.3" fontSize="12" fontFamily="monospace" fontWeight="bold">12%</text>
          <text x="65" y="195" textAnchor="middle" fill="white" opacity="0.2" fontSize="9" fontFamily="monospace">Advertised</text>
          <rect x="130" y="120" width="40" height="50" rx="3" fill="#D8400E" opacity="0.1" />
          <text x="150" y="150" textAnchor="middle" fill="#D8400E" opacity="0.25" fontSize="8" fontFamily="monospace">Tax</text>
          ...
          <text x="225" y="195" textAnchor="middle" fill="white" opacity="0.2" fontSize="9" fontFamily="monospace">Reality</text>
